...
namespace weasel.Scopes {
    ...
    internal class MethodScope : IProxyScope {
        ...
        /// </summary>
        /// <param name="methodInfo">The MethodInfo describing the method to scope.</param>
        /// <param name="methodParameters">The parameter of the method. Could be emtpy if no ParameterScope is needed.</param>
        ...
        public List<object> ParameterValues {
            get {
                // Compile and Eval the ParameterExpressions.
